package org.jsack.tifsa.Reports.Discount.ShowTotalDiscountsGivenPerWeek;
...
public class Report implements IReport{
     ...
     */
    private final String sql = "SELECT MONTH(dbo.[Order].OrderDate) AS Week,\n" +
     ...
     */
    private final String name = "Show Total Discounts Given By Week";
    ...
    public FXMLLoader getControls() throws IOException {
        return new FXMLLoader(getClass().getResource("/ReportControls/ShowTotalDiscountsGivenPerWeek.fxml"));
    }
}
