...
public class Report implements IReport{
    ...
    private final String sql = "SELECT YEAR(dbo.[Order].OrderDate) AS Year,\n" +
            ...
            "dbo.EmployeeType.EmployeeTypeDescription FROM OrderDiscount\n" +
            "\n" +
            ...
            "\n" +
            "WHERE (EmployeeType.EmployeeTypeID='4' OR EmployeeType.EmployeeTypeID='5' OR EmployeeType.EmployeeTypeID='6') AND (DATEPART(year, dbo.[Order].OrderDate) = 2008) AND OrderDiscount.Deleted = '0'\n" +
            "\n" +
     ...
     */
    private final String name = "Show Total Discounts Given By Year";
    ...
    public FXMLLoader getControls() throws IOException {
        return new FXMLLoader(getClass().getResource("/ReportControls/ShowTotalDiscountsGivenByYear.fxml"));
    }
}
