package org.jsack.tifsa.Reports.Discount.ShowTotalDiscountsGivenPerDay;
...
public class Report implements IReport{
     ...
     */
    private final String sql = "SELECT DATEPART(day, dbo.[Order].OrderDate) AS Day,\n" +
            "DATEPART(Month, dbo.[Order].OrderDate) AS Month,\n" +
     ...
     */
    private final String name = "Show Total Discounts Given By Day";
    ...
    public FXMLLoader getControls() throws IOException {
        return new FXMLLoader(getClass().getResource("/ReportControls/ShowTotalDiscountsGivenPerDay.fxml"));
    }
}
