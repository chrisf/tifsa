package org.jsack.tifsa.Reports.Order.ShowOrdersCompletedByMonth;
...
public class Report implements IReport{
    ...
    private final String sql = "SELECT\n" +
            "  CAST(YEAR([Order].OrderDate) AS VARCHAR) + '/' + CAST(DATEPART(m, [Order].OrderDate) AS VARCHAR) AS [Month],\n" +
            ...
            "\n" +
            "WHERE DATEPART(month,[Order].OrderDate) = '09' AND DATEPART(year, [Order].OrderDate)= '2009' AND [Order].Deleted = 0\n" +
            "\n" +
            ...
            "ORDER BY [Month] DESC, [Revenue] DESC, EmployeeLast, EmployeeFirst";

    /*
        TODO: Name your report.
        Set the name of your report here. Make it unique.
     */
    private final String name = "Show Orders Completed By Month";
    ...
    public FXMLLoader getControls() throws IOException {
        return new FXMLLoader(getClass().getResource("/ReportControls/ShowOrdersCompletedByMonth.fxml"));
    }
}
