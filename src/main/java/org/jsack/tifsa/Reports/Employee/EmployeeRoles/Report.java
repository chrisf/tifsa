package org.jsack.tifsa.Reports.Employee.EmployeeRoles;
...
public class Report implements IReport{
    ...
    private final String sql = "SELECT\n" +
            ...
            "dbo.EmployeeType.EmployeeTypeDescription AS 'Position',\n" +
            "dbo.EmployeeStatus.EmployeeStatusDescription \n" +
            "\n" +
            "FROM Employee\n" +
     ...
     */
    private final String name = "Employee Roles";
    ...
    public FXMLLoader getControls() throws IOException {
        return new FXMLLoader(getClass().getResource("/ReportControls/EmployeeRoles.fxml"));
    }
}
