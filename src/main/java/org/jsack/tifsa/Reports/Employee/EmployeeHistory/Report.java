...
public class Report implements IReport{
    ...
    private final String sql = "SELECT\n" +
            ...
            "dbo.EmployeeHistory.EmployeeHistoryBeginDate AS 'Begin Date',\n" +
            "dbo.EmployeeHistory.EmployeeHistoryEndDate  AS 'End Date',\n" +
            "dbo.EmployeeHistoryType.EmployeeHistoryTypeDescription AS 'Employee Type',\n" +
            "o1.RoleCount\n" +
            "\n" +
            "FROM Employee\n" +
            "\n" +
            ...
            "INNER JOIN EmployeeHistoryType ON EmployeeHistory.EmployeeHistoryTypeID = EmployeeHistoryType.EmployeeHistoryTypeID\n" +
            "\n" +
            "WHERE Employee.EmployeeID = 5 AND Employee.Deleted = '0'\n" +
            "\n" +
     ...
     */
    private final String name = "Employee History";
    ...
    public FXMLLoader getControls() throws IOException {
        return new FXMLLoader(getClass().getResource("/ReportControls/EmployeeHistory.fxml"));
    }
}
