package org.jsack.tifsa.Reports.Employee.EmployeeRevenueByWeek;
...
public class Report implements IReport{
    ...
    private final String sql = "SELECT dbo.EmployeeType.EmployeeTypeDescription, e1.EmployeeFirst, e1.EmployeeLast, o1.Total\n" +
            ...
            "\tFROM dbo.[Order]\n" +
            "\tWHERE [Order].OrderDate > '2016-2-1' AND [Order].OrderDate < '2016-2-29'\n" +
     ...
     */
    private final String name = "Employee Revenue By Week";
    ...
    public FXMLLoader getControls() throws IOException {
        return new FXMLLoader(getClass().getResource("/ReportControls/EmployeeRevenueByWeek.fxml"));
    }
}
