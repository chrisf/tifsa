...
public class Report implements IReport{
    ...
    private final String sql = "SELECT\n" +
            ...
            "\n" +
            "WHERE VendorContact.VendorContactPrimary = 1\n";

    /*
        TODO: Name your report.
        Set the name of your report here. Make it unique.
     */
    private final String name = "Show All Vendors";
    ...
    public FXMLLoader getControls() throws IOException {
        return new FXMLLoader(getClass().getResource("/ReportControls/ShowAllVendors.fxml"));
    }
}
