...
public class Report implements IReport{
    ...
    private final String sql = "SELECT DATEPART(year, dbo.[Order].OrderDate) AS Year,\n" +
            "SUM(dbo.OrderLine.OrderLineQuantity) AS TotalProductsInYear,\n" +
            ...
            "\n" +
            "WHERE DATEPART(year, dbo.[Order].OrderDate) = '2016' AND [Order].Deleted = '0'\n" +
            "\n" +
     ...
     */
    private final String name = "Show Total Products Sold By Year";
    ...
    public FXMLLoader getControls() throws IOException {
        return new FXMLLoader(getClass().getResource("/ReportControls/ShowTotalProductsSoldByYear.fxml"));
    }
}
