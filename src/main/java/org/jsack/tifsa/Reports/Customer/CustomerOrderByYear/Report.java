...
public class Report implements IReport{
    ...
    private final String sql = "SELECT DATEPART(year, dbo.[Order].OrderDate) AS 'Year', \n" +
            ...
            "\n" +
            "WHERE DATEPART(year, dbo.[Order].OrderDate) = '2009'\n" +
            "\n" +
            "order by dbo.customer.CustomerFirst, dbo.OrderDiscount.OrderDiscountAmount;";

    /*
        TODO: Name your report.
        Set the name of your report here. Make it unique.
     */
    private final String name = "Customer Orders By Year";
    ...
    public FXMLLoader getControls() throws IOException {
        return new FXMLLoader(getClass().getResource("/ReportControls/CustomerOrderByYear.fxml"));
    }
}
