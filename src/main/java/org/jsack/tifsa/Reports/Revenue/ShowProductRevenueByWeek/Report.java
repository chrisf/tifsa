...
public class Report implements IReport{
    ...
    private final String sql = "SELECT YEAR([Order].OrderDate) as 'Year',\n" +
            ...
            "\n" +
            "WHERE DATEPART(year, [Order].OrderDate) = '2016' AND DATEPART(month, [Order].OrderDate) = '3' AND (dbo.[Order].OrderDate BETWEEN '2016-02-28' AND '2016-03-05') AND OrderLine.Deleted = '0'\n" +
            "\n" +
            "GROUP BY YEAR([Order].OrderDate), DATENAME(month,[Order].OrderDate), DATEPART(week,dbo.[Order].OrderDate), Product.ProductSKU, Product.ProductDescription, Product.ProductPrice, Vendor.VendorName, Brand.BrandName, Manufacturer.ManufacturerName";

    /*
        TODO: Name your report.
        Set the name of your report here. Make it unique.
     */
    private final String name = "Show Product Revenue By Week";
    ...
    public FXMLLoader getControls() throws IOException {
        return new FXMLLoader(getClass().getResource("/ReportControls/ShowProductRevenueByWeek.fxml"));
    }
}
