...
public class Report implements IReport{
    ...
    private final String sql = "SELECT\n" +
            ...
            "WHERE DATEPART(year, [Order].OrderDate) = '2016' AND DATEPART(month, [Order].OrderDate) = '3' AND OrderLine.Deleted = 0\n" +
            "GROUP BY YEAR([Order].OrderDate), DATENAME(month,[Order].OrderDate), Product.ProductSKU, Product.ProductDescription, Product.ProductPrice, Vendor.VendorName, Brand.BrandName, Manufacturer.ManufacturerName\n";

    /*
        TODO: Name your report.
        Set the name of your report here. Make it unique.
     */
    private final String name = "Show Product Revenue By Month";
    ...
    public FXMLLoader getControls() throws IOException {
        return new FXMLLoader(getClass().getResource("/ReportControls/ShowProductRevenueByMonth.fxml"));
    }
}
