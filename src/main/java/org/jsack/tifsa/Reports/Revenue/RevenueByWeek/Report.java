package org.jsack.tifsa.Reports.Revenue.RevenueByWeek;
...
public class Report implements IReport{
    ...
    private final String sql = "SELECT\n" +
            ...
            "\n" +
            "WHERE [Order].OrderDate BETWEEN :dayStart AND :dayEnd\n" +
            "AND [Order].Deleted = 0\n";
     ...
     */
    private final String name = "Revenue By Week";
    ...
    public FXMLLoader getControls() throws IOException {
        return new FXMLLoader(getClass().getResource("/ReportControls/OrdersBySpecificWeek.fxml"));
    }
}
