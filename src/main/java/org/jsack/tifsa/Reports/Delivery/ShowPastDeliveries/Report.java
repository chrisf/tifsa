...
public class Report implements IReport{
    ...
    private final String sql = "SELECT\n" +
            ...
            "\n" +
            "WHERE OrderLine.OrderLineDelivered != 0 AND OrderLine.Deleted = 0\n" +
            "\n" +
            "ORDER BY OrderLine.OrderLineDelivered\n";

    /*
        TODO: Name your report.
        Set the name of your report here. Make it unique.
     */
    private final String name = "Show Past Deliveries";
    ...
    public FXMLLoader getControls() throws IOException {
        return new FXMLLoader(getClass().getResource("/ReportControls/ShowPastDeliveries.fxml"));
    }
}
