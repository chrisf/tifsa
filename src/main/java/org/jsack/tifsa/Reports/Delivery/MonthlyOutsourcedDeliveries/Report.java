...
public class Report implements IReport{
    ...
    private final String sql = "SELECT\n" +
            ...
            "dbo.OrderLine.OrderLineDelivered AS 'Date Delivered',\n" +
            ...
            "\n" +
            "WHERE OrderLine.OrderLineDelivered != 0 AND OrderLineDelivered >= '2006-06-01' AND OrderLineDelivered<= '2006-06-30 23:59:59' AND\n" +
            "OrderLineDeliveryTypeDescription = 'UPS' OR\n" +
            "OrderLineDeliveryTypeDescription = 'DHL' AND [Order].Deleted = '0'\n";

    /*
        TODO: Name your report.
        Set the name of your report here. Make it unique.
     */
    private final String name = "Monthly Outsourced Deliveries";
    ...
    public FXMLLoader getControls() throws IOException {
        return new FXMLLoader(getClass().getResource("/ReportControls/MonthlyOutsourcedDeliveries.fxml"));
    }
}
