package org.jsack.tifsa.Reports.Delivery.DailyPickupItems;
...
public class Report implements IReport{
    ...
    private final String sql = "SELECT \n" +
            ...
            "\n" +
            "WHERE CustomerContact.[CustomerContactPrimary] = 1 AND  OrderLineDeliveryTypeID = 2 AND OrderLineDeliverOn = '2016-05-22 00:00:00.000' AND [Customer].Deleted = 0;\n";

    /*
        TODO: Name your report.
        Set the name of your report here. Make it unique.
     */
    private final String name = "Daily Pickup Items";
    ...
    public FXMLLoader getControls() throws IOException {
        return new FXMLLoader(getClass().getResource("/ReportControls/DailyPickupItems.fxml"));
    }
}
