...
public class Report implements IReport{
    ...
    private final String sql = "SELECT\n" +
            ...
            "\n" +
            "WHERE DATEPART(year, dbo.OrderLine.OrderLineDeliverOn) = '2016' AND DATEPART(month, dbo.OrderLine.OrderLineDeliverOn) ='06' AND DATEPART(day, dbo.OrderLine.OrderLineDeliverOn) = '18' AND [Order].Deleted = 0\n";

    /*
        TODO: Name your report.
        Set the name of your report here. Make it unique.
     */
    private final String name = "Daily Delivery Report";
    ...
    public FXMLLoader getControls() throws IOException {
        return new FXMLLoader(getClass().getResource("/ReportControls/DailyDeliveryReport.fxml"));
    }
}
